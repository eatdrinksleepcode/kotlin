...
fun test(notRange1: NotRange1, notRange2: NotRange2, notRange3: NotRange3, notRange4: NotRange4, notRange5: NotRange5, notRange6: NotRange6, notRange7: NotRange7, notRange8: NotRange8, range0: Range0, range1: Range1) {
  <!ITERATOR_MISSING!>for (i in notRange1)<!>;
  <!HAS_NEXT_MISSING!>for (i in notRange2)<!>;
  <!NEXT_MISSING!>for (i in notRange3)<!>;
  <!HAS_NEXT_MISSING!>for (i in notRange4)<!>;
  for (i in notRange5);
  for (i in notRange6);
  for (i in notRange7);
  <!HAS_NEXT_MISSING!>for (i in notRange8)<!>;
  for (i in range0);
  for (i in range1);
